...
@omen/cli/0.6.9 linux-x64 node-v10.14.2
$ omen --help [COMMAND]
USAGE
  $ omen COMMAND
...
...
_See code: [src/commands/build.js](https://github.com/commit-intl/omen/blob/v0.6.9/src/commands/build.js)_
...
_See code: [src/commands/export.js](https://github.com/commit-intl/omen/blob/v0.6.9/src/commands/export.js)_
...
_See code: [src/commands/serve.js](https://github.com/commit-intl/omen/blob/v0.6.9/src/commands/serve.js)_
<!-- commandsstop -->
